...
<head>
    ...
    <style> .cart-item { display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #333; padding: 1rem 0; color: white;} </style>
</head>
<body>
    ...
    <section class="section">
        <div class="container" style="max-width: 600px; background: rgba(17,17,17,0.9); padding: 2rem; border: 1px solid #333; margin-top: 5rem;">
            ...
            <?php else: ?>
                ...
                <div style="margin-top: 3rem; display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <?php else: ?>
                        <form action="/checkout" method="POST">
                            <button type="submit" class="btn primary" style="width: 100%; background: transparent; border: 1px solid #c49a6c; color: #c49a6c;">KUPUJ JAKO GOŚĆ</button>
                        </form>
                        <p style="text-align: center; color: gray; font-size: 0.9rem;">
                            Masz konto? <a href="/login" style="color: #c49a6c;">Zaloguj się</a>
                        </p>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
